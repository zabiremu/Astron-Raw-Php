...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Banner Details Show</h1>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="./BannerEdit.php?id=<?=$data['id']?>" class="btn btn-primary btn-sm">Edit</a></td>
                    <td><a href="./controller/BannerDelete.php?id=<?=$data['id']?>" class="btn btn-danger btn-sm">Delete</a></td>
                </tr>
            <?php
            }
            ?>
